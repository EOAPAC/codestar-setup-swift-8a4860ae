...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Celebrating founders and their journeys. Submit your story for the 2026 Entrepreneur Awards. Winners turn their recognition into a published feature and a keepsake award." },
      { property: "og:title", content: "The Entrepreneur Awards — For the person who built it." },
      { property: "og:description", content: "Celebrating founders and their journeys. Submit your story for the 2026 Entrepreneur Awards. Winners turn their recognition into a published feature and a keepsake award." },
